...
MTD2A_binary_input  FC_51_stop  ("Stop",  10000, LAST_TRIGGER, TIME_DELAY);   // continous active time (no drop outs)
...
void setup() {
  ...
  FC_51_stop.initialize   (2);  // Arduino board input pin 2
  train_sound.initialize  (9);  // Arduino board Output pin 9 
